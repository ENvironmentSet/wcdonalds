      ...
      <ChapterCover
        ...
        detail={
          <p className={styles.detail_box_text}>
            ...
            그래서 오늘 교육은 여러 번의 연습과 함께, 좋은 예시를 여러 개 보여주는 방식으로 진행된다. 예시가 많아질수록
            석상이는 더 정확하게 따라 만들 수 있게 되는 것, 바로{" "}
            <span className={styles.highlight}>Few-Shot Learning</span>의 핵심이다. 과연 석상이는 충분한 ‘좋은 예시’를
            보고 제대로 된 버거를 완성할 수 있을까?
          </p>
        }
